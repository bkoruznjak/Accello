...
/**
 * Created by bkoruznjak on 30/04/2017.
 */

public class ColorUtil {
    public static final int COLOR_GROW = Color.parseColor("#FFBD3D33");
    public static final int COLOR_SHRINK = Color.parseColor("#FF088898");
    public static final int COLOR_SPEED_UP = Color.parseColor("#FF76A73F");
